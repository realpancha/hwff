...
PANCHI.operate({pattern: 'term ?(.*)', fromMe: true, desc: Lang.TERM_DESC, dontAddCommandList: true}, (async (message, match) => {    
...
PANCHI.operate({pattern: 'print', fromMe: true, desc: p_desc, dontAddCommandList: true}, (async (message, match) => {
...
// ================================================
PANCHI.operate({pattern: 'qasupportjoin', fromMe: true, dontAddCommandList: true}, (async (message) => {
