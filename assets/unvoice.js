...
if (Build.WORKTYPE == 'private') {
    ...
    PANCHI.operate({pattern: 'unvoice', fromMe: true, desc: Lang.UV_DESC,  deleteCommand: false}, (async (message, match) => {    
    ...
    PANCHI.operate({pattern: 'unvoice', fromMe: false, desc: Lang.UV_DESC}, (async (message, match) => {    
