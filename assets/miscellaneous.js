...
const PANCHI = require('queenPANCI_PANCHI-public');
...
PANCHI.operate({pattern: 'insta ?(.*)', fromMe: Work_Mode,  deleteCommand: false, desc: Lang.IGSTALK}, (async (PANCI_PANCHIMSG, match) => {

    const username = match[1]

    if (username === '') return await PANCI_PANCHIMSG.client.sendMessage(PANCI_PANCHIMSG.jid, Lang.NEED_USERNAME, MessageType.text, {quoted: PANCI_PANCHIMSG.data});

    await _PANCHI.instaProfile( PANCI_PANCHIMSG, username, Lang )
}));

PANCHI.operate({pattern: 'trt(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: Work_Mode}, (async (message, match) => {
...
PANCHI.operate({pattern: 'tts (.*)', fromMe: Work_Mode,  deleteCommand: false, desc: Lang.TTS_DESC}, (async (message, match) => {
...
PANCHI.operate({pattern: 'wiki ?(.*)', fromMe: Work_Mode,  deleteCommand: false, desc: Lang.WIKI_DESC}, (async (message, match) => { 
...
PANCHI.operate({pattern: 'quote ?(.*)', fromMe: Work_Mode,  deleteCommand: false, desc: Lang.QUOTE_DESC}, async (message, match) => {
...
PANCHI.operate({pattern: 'wame ?(.*)', fromMe: Work_Mode,  deleteCommand: false, desc: Lang.WAME_DESC}, (async (message, match) => {    
...
PANCHI.operate({pattern: 'ss ?(.*)', fromMe: Work_Mode, desc: Lang.SS_DESC,  deleteCommand: false}, (async (message, match) => {
    await PANCHI.PANCI_PANCHI_setup()
...
PANCHI.operate({pattern: 'mp4audio', fromMe: Work_Mode,  deleteCommand: false, desc: Lang.MP4TOAUDİO_DESC}, (async (message, match) => {    
...
PANCHI.operate({pattern: 'imagesticker', fromMe: Work_Mode,  deleteCommand: false, desc: Lang.STİCKER_DESC}, (async (message, match) => {   
...
PANCHI.operate({pattern: 'img ?(.*)', fromMe: Work_Mode,  deleteCommand: false, desc: Lang.IMG_DESC}, (async (PANCI_PANCHIMSG, input) => { 
    const query = input[1]
    if (query === '') return await PANCI_PANCHIMSG.client.sendMessage(PANCI_PANCHIMSG.jid, Lang.NEED_WORDS, MessageType.text, {quoted: PANCI_PANCHIMSG.data});

    await _PANCHI.imageDL( PANCI_PANCHIMSG, query, Lang )
}));

PANCHI.operate({pattern: 'ocr', fromMe: Work_Mode,  deleteCommand: false, desc: Lang.OCR_DESC}, (async (message, match) => { 
