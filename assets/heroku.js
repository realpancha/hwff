...
PANCHI.operate({ pattern: 'restart', fromMe: true, desc: Lang.RESTART_DESC, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
...
PANCHI.operate({ pattern: 'shutdown', fromMe: true, desc: Lang.SHUTDOWN_DESC, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
...
PANCHI.operate({ pattern: 'dyno', fromMe: true, desc: Lang.DYNO_DESC, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
...
PANCHI.operate({ pattern: 'setvar ?(.*)', fromMe: true, desc: Lang.SETVAR_DESC, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
...
PANCHI.operate({ pattern: 'delvar ?(.*)', fromMe: true, desc: Lang.DELVAR_DESC, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
...
PANCHI.operate({ pattern: 'getvar ?(.*)', fromMe: true, desc: Lang.GETVAR_DESC, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
...
PANCHI.operate({ pattern: 'allconfig', fromMe: true, desc: Lang.GETVAR_DESC, dontAddCommandList: true, deleteCommand: false }, (async (PANCHIMSG) => {
    await _PANCHI.allConfig(PANCHIMSG)
}));


PANCHI.operate({ pattern: 'setup ?(.*)', fromMe: true, desc: Lang.SETUP_DESC, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
