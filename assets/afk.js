...
PANCHI.operate({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
...
PANCHI.operate({pattern: 'online ?(.*)', fromMe: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
...
PANCHI.operate({pattern: 'afk ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.AFK_DESC, dontAddCommandList: true}, (async (message, match) => {     
    if (!AFK.isAfk) {
