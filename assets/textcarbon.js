...
if (Build.WORKTYPE == 'private') {
    ...
    PANCHI.operate({pattern: 'carbon$', fromMe: true, desc: Lang.CARBON_DESC,  deleteCommand: false}, (async (message, match) => {
    ...
    PANCHI.operate({pattern: 'carbon$', fromMe: false, desc: Lang.CARBON_DESC}, (async (message, match) => {
        await PANCHI.PANCHI_setup()
        if (!message.reply_message) return await message.client.sendMessage(message.jid,Lang.NEED_WORD, MessageType.text);
